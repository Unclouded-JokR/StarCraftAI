...
BWAPI::Unit Tools::GetClosestUnitToWOWorker(BWAPI::Position p, const BWAPI::Unitset& units)
{
...
BWAPI::Unit Tools::GetClosestUnitToWOWorker(BWAPI::Unit unit, const BWAPI::Unitset& units)
{
    if (!unit) { return nullptr; }
